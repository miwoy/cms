module.exports = function (customError) {
	 ...
	 * 参数不存在
	 */
	class RequiredArgsGeneralityError extends ArgsGeneralityError {
		constructor(msg) {
			super("不存在的参数." + (msg || ""));
			this.name = "RequiredArgsGeneralityError";
			this.errno = 3104;
		}
	}
	customError.RequiredArgsGeneralityError = RequiredArgsGeneralityError;
	/**
     ...
     * Not Found
     */
	class RequiredDataGeneralityError extends DataGeneralityError {
		constructor(msg) {
			super("不存在的数据." + (msg || ""));
			this.name = "RequiredDataGeneralityError";
			this.errno = 3204;
		}
	}
	customError.RequiredDataGeneralityError = RequiredDataGeneralityError;
};